...
<script type="text/javascript" src="<?php echo $site?>/media/wysiwyg/scripts/wysiwyg-popup.js"></script>
...
<td style="vertical-align: top;width: 150px; padding-left: 5px;">
	...
	<iframe id="chooser" frameborder="0" style="height:165px;width: 180px;border: 2px solid #FFFFFF; padding: 5px;" src="<?php echo $site?>/openwysiwyg/select_image?dir=<?php echo $leadon; ?>"></iframe>
</td>
</tr>
<tr>
