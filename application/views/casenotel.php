...
$(document).ready(function()
{
	$(".table #delete").click(function() {
		if(confirm('<?php echo $message['confirm_delete'];?>')){
			var img = $(this);
			var jqxhr=$.get("<?php echo $site?>/casenote/del?what=del&id="+$(this).attr("data"),function(response, status, xhr){
...
Attachment</th>
		...
		<tr>
				...
				<td><a href="<?php echo $site?>/casenote?id=<?php echo $l['id'];?>" class="label label-info"><i class="icon-edit"></i> edit</a></td>
