...
$(document).ready(function()
{
	$(".table #delete").click(function() {
		if(confirm('<?php echo $message['confirm_delete'];?>')){
			var img = $(this);
			var jqxhr=$.get("<?php echo $site?>/appointment/del?what=del&id="+$(this).attr("data"),function(response, status, xhr){
...
Date</th>
		...
		<tr>
				...
				<td><?php echo $l['doctorid'];?></td>
				<td><?php echo $l['date'];?></td>
				<td><a href="<?php echo $site?>/appointment?id=<?php echo $l['id'];?>" class="label label-info"><i class="icon-edit"></i> edit</a></td>
