...
$(document).ready(function()
{
	$(".table #delete").click(function() {
		if(confirm('<?php echo $message['confirm_delete'];?>')){
			var img = $(this);
			var jqxhr=$.get("<?php echo $site?>/specialist/del?what=del&id="+$(this).attr("data"),function(response, status, xhr){
...
<div class="widget-header">
    <h3><i class="icon-list"></i> List of Specialists</h3>
</div> 
...
Names</th>
		...
		<tr>
				...
				<td><a href="<?php echo $site?>/specialist?id=<?php echo $l['id'];?>" class="label label-info"><i class="icon-edit"></i> edit</a></td>
