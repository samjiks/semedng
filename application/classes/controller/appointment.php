...
class Controller_Appointment extends Controller_CController
{
	protected $model;
	public function __construct($request)
	{
		parent::__construct($request);
		$this->model=Model::factory('appointmentmd');
	...
	public function action_list()
	{
		...
		$view=View::factory("appointmentl");
		$view->list=null;
		$view->paging=null;
		...
		try
		{
			...
			$paging=Pagination::factory(array('base_url'=> "appointment/list/",'uri_segment' => 'page','total_items'=> $total, 'items_per_page' => $volume, 'style'=> 'digg'));
			$view->paging=$paging;
		}
		catch(Exception $e)
		{
	...
	{
		$view = View::factory('appointmentm');
		$errors=array();
		$where='';
		$post=array();
		try
		{
			...
			elseif(isset($_POST['submit']))
			{
				...
				$this->request->redirect("appointment/index");
			}
		}
		catch(Exception $e)
		{
